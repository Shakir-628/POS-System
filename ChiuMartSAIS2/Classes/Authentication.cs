...
namespace ChiuMartSAIS2.Classes
{
    class Authentication
    {
        ...
        public int endshiftMonitoring { get; set; }
                ...
                using (SqlConnection con = new SqlConnection(conf.connectionstring))
                {
                    ...
                    while (reader.Read())
                    {
                        if (reader.HasRows)
                        {
                            ...
                            endshiftMonitoring = (int)reader["EndShiftmonitoring"];
                            SalesReturn = (int)reader["SalesReturn"];
                            val = true;
                        }
                    }
                }
