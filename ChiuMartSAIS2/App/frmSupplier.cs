...
namespace ChiuMartSAIS2.App
{
    public partial class frmSupplier : Form
    {
        ...
        private string supplierTotalBalance = "";
        private string supplierRemainingBalance = "";
            ...
            using (SqlConnection Con = new SqlConnection(conf.connectionstring))
            {
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        listView1.Items[listView1.Items.Count - 1].SubItems.Add(reader["DateReminder"].ToString());
                        listView1.Items[listView1.Items.Count - 1].SubItems.Add(reader["TotalBalance"].ToString());
                        listView1.Items[listView1.Items.Count - 1].SubItems.Add(reader["RemainingBalance"].ToString());
        ...
        private void insertSupplier(string supplierName, string supplierAddress, string supplierContact, string supplierContactPerson, DateTime supplierDate, string supplierTotalBalance, string supplierRemainingBalance)
        {
            using (SqlConnection Con = new SqlConnection(conf.connectionstring))
            {
                try
                {
                    ...
                    sqlCmd.Parameters.AddWithValue("DateReminder", supplierDate);
                    sqlCmd.Parameters.AddWithValue("TotalBalance", supplierTotalBalance);
                    sqlCmd.Parameters.AddWithValue("RemainingBalance", supplierRemainingBalance);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (frmSupplierAdd.ShowDialog(this) == DialogResult.OK)
            {
                ...
                frmSupplierAdd.getSupplier(out supplierId, out supplierName, out supplierAddress, out supplierContact, out supplierContactPerson, out supplierDate, out supplierTotalBalance, out supplierRemainingBalance);
                insertSupplier(supplierName, supplierAddress, supplierContact, supplierContactPerson, supplierDate, supplierTotalBalance, supplierRemainingBalance);
                populateSupplier();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            frmSupplierEdit.supplierDate = Convert.ToDateTime(this.supplierDate);
            frmSupplierEdit.supplierTotalBalance = this.supplierTotalBalance;
            frmSupplierEdit.supplierRemainingBalance = this.supplierRemainingBalance;
            ...
            {
                // If all validations were valid, we're going to get the supplier
                frmSupplierEdit.getSupplier(out supplierId, out supplierName, out supplierAddress, out supplierContact, out supplierContactPerson, out supplierDate, out supplierTotalBalance, out supplierRemainingBalance);
                updateSupplier(supplierName, supplierAddress, supplierContact, supplierContactPerson, supplierDate, supplierTotalBalance, supplierRemainingBalance, supplierId);
                populateSupplier();
            }
        }
        ...
        private void listView1_Click(object sender, EventArgs e)
        {
            ...
            supplierDate = Convert.ToDateTime(listView1.SelectedItems[listView1.SelectedItems.Count - 1].SubItems[2].Text);
            supplierTotalBalance = listView1.SelectedItems[listView1.SelectedItems.Count - 1].SubItems[3].Text;
            supplierRemainingBalance = listView1.SelectedItems[listView1.SelectedItems.Count - 1].SubItems[4].Text;
            supplierAddress = listView1.SelectedItems[listView1.SelectedItems.Count - 1].SubItems[5].Text;
            supplierContact = listView1.SelectedItems[listView1.SelectedItems.Count - 1].SubItems[6].Text;
            supplierContactPerson = listView1.SelectedItems[listView1.SelectedItems.Count - 1].SubItems[7].Text;
        }
