...
namespace ChiuMartSAIS2.App
{
    public partial class frmClient : Form
    {
        ...
        private string NIC = "";
        private string guranteeDetails = "";
            ...
            using (MySqlConnection Con = new MySqlConnection(conf.connectionstring))
            {
                try
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        listView1.Items[listView1.Items.Count - 1].SubItems.Add(reader["NIC"].ToString());
                        listView1.Items[listView1.Items.Count - 1].SubItems.Add(reader["guranteeDetails"].ToString());
                        listView1.Items[listView1.Items.Count - 1].SubItems.Add(reader["otherDetails"].ToString());
                        listView1.Items[listView1.Items.Count - 1].SubItems.Add(reader["categoryType"].ToString());
        ...
        private void insertClient(string clientName, string clientAddress, string clientContact, string NIC, string guranteeDetails, string otherDetails, string cateogoryType)
        {
            using (MySqlConnection Con = new MySqlConnection(conf.connectionstring))
            {
                try
                {
                    ...
                    sqlCmd.Parameters.AddWithValue("guranteeDetails", guranteeDetails);
                    sqlCmd.Parameters.AddWithValue("otherDetails", otherDetails);
                    sqlCmd.Parameters.AddWithValue("categoryType", cateogoryType);
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (frmClientAdd.ShowDialog(this) == DialogResult.OK)
            {
                ...
                frmClientAdd.getClient(out clientId, out clientName, out clientAddress, out clientContact, out NIC, out guranteeDetails, out otherDetails, out categoryType);
                insertClient(clientName, clientAddress, clientContact, NIC, guranteeDetails, otherDetails, categoryType);
                populateClient();
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            frmClientEdit.CNIC = this.NIC;
            frmClientEdit.guranteeDetials = this.guranteeDetails;
            frmClientEdit.otherDetails = this.otherDetails;
            frmClientEdit.categoryType = this.categoryType;
            ...
            {
                // If all validations were valid, we're going to get the category
                frmClientEdit.getClient(out clientId, out clientName, out clientAddress, out clientContact, out NIC, out guranteeDetails, out otherDetails, out categoryType);
                updateClient(clientName, clientAddress, clientContact, clientId, NIC, guranteeDetails, otherDetails, categoryType);
                populateClient();
            }
        }
        ...
        private void listView1_Click(object sender, EventArgs e)
        {
            ...
            NIC = listView1.SelectedItems[listView1.SelectedItems.Count - 1].SubItems[4].Text;
            guranteeDetails = listView1.SelectedItems[listView1.SelectedItems.Count - 1].SubItems[5].Text;
            otherDetails = listView1.SelectedItems[listView1.SelectedItems.Count - 1].SubItems[6].Text;
            categoryType = listView1.SelectedItems[listView1.SelectedItems.Count - 1].SubItems[7].Text;
        }
