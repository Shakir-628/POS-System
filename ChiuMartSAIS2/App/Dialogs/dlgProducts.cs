...
namespace ChiuMartSAIS2.App.Dialogs
{
    public partial class dlgProducts : Form
    {
        ...
        public void getProduct(out double productId, out double productPrice, out double productSafetyStock, out double productStocks,
            out string productName, out string productCategory, out string productUnit, out string barcode, out string retailPrice)
        {
            // Set the product id
            productId = _crit;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (_action == "add")
            {
                double price, stock, safetystock, retailPrice;
                ...
                else if (!(double.TryParse(txtRetailPrice.Text, out retailPrice)))
                {
                    MessageBox.Show("Retail Price must be a number", "Notification", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            txtBarcode.Text = objfun.randomBarcode();
        }
    }
}
